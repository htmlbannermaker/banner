...
lib.ssMetadata = [
		{name:"181208_adtr_300x600_atlas_P_", frames: [[559,1780,40,195],[498,1780,59,199],[643,1598,67,199],[656,1230,89,197],[498,1432,142,186],[642,1432,132,164],[498,1620,143,158],[604,0,194,235],[604,237,194,235],[302,0,300,250],[604,474,194,235],[302,252,300,250],[498,993,194,235],[302,504,300,250],[302,756,194,235],[302,1467,194,235],[302,1704,194,235],[498,756,194,235],[302,1230,194,235],[302,993,194,235],[0,756,300,250],[0,1008,300,250],[0,1260,300,250],[0,1512,300,250],[0,0,300,250],[498,1230,156,200],[0,1764,300,250],[0,252,300,250],[0,504,300,250]]},
		{name:"181208_adtr_300x600_atlas_NP_", frames: [[0,0,300,250],[0,252,300,250]]}
];
...
(lib._1 = function() {
	this.initialize(ss["181208_adtr_300x600_atlas_P_"]);
	this.gotoAndStop(0);
...
(lib.bg_norust = function() {
	this.initialize(ss["181208_adtr_300x600_atlas_NP_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.Symbol57 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#003660").s().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
...
(lib.Symbol54 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.shield2();
	this.instance.parent = this;
	this.instance.setTransform(-2.3,28,0.5386,0.5386,-7.4659);
...
p.nominalBounds = new cjs.Rectangle(-2.3,0,145.3,158);
...
(lib.Symbol35 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(27.9199,60.2031,1.1452,1.1563,33.2285);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol35, new cjs.Rectangle(-11.8,17.5,79.5,85.5), null);
...
(lib.Symbol56 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_61 = new cjs.Graphics().p("AqggSQgvAAAAgwIAAjNQAAgwAvAAIVBAAQAvAAAAAwIAADNQAAAwgvAAg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(61).to({graphics:mask_graphics_61,x:66.1,y:-31.95}).wait(80));

	// light
	this.instance = new lib.Symbol35();
	this.instance.parent = this;
	this.instance.setTransform(-45.75,-76.55,1.2069,1.1873,0,0,0,34.6,37.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(61).to({_off:false},0).to({x:179.85},10).wait(1).to({x:-45.75},0).to({x:194.85},10).wait(17).to({x:-45.75},0).to({x:179.85},10).wait(1).to({x:-45.75},0).to({x:194.85},10).wait(21));

	// cta.png
	this.instance_1 = new lib.Symbol13();
	this.instance_1.parent = this;
	this.instance_1.setTransform(64.7,-27,1,1,0,0,0,214.7,223);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(33).to({_off:false},0).to({y:-48.5,alpha:1},16,cjs.Ease.backOut).wait(92));

	// t11.png
	this.instance_2 = new lib.Symbol4();
	this.instance_2.parent = this;
	this.instance_2.setTransform(180,-204,1,1,0,0,0,150,125);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(7).to({_off:false},0).to({x:0,alpha:1},16,cjs.Ease.backOut).wait(118));

	// t12.png
	this.instance_3 = new lib.Symbol5();
	this.instance_3.parent = this;
	this.instance_3.setTransform(200,-204,1,1,0,0,0,150,125);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(9).to({_off:false},0).to({x:0,alpha:1},16,cjs.Ease.backOut).wait(116));

	// t13.png
	this.instance_4 = new lib.Symbol6();
	this.instance_4.parent = this;
	this.instance_4.setTransform(210,-204,1,1,0,0,0,150,125);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({x:0,alpha:1},16,cjs.Ease.backOut).wait(114));
	...
	var mask_1_graphics_42 = new cjs.Graphics().p("AqWD9IAAn5IUtAAIAAH5g");
	var mask_1_graphics_43 = new cjs.Graphics().p("AqWD9IAAn5IUtAAIAAH5g");
	var mask_1_graphics_44 = new cjs.Graphics().p("AqWD9IAAn5IUtAAIAAH5g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(28).to({graphics:mask_1_graphics_28,x:-65.975,y:-188.025}).wait(1).to({graphics:mask_1_graphics_29,x:-51.025,y:-188.025}).wait(1).to({graphics:mask_1_graphics_30,x:-37.925,y:-188.025}).wait(1).to({graphics:mask_1_graphics_31,x:-26.575,y:-188.025}).wait(1).to({graphics:mask_1_graphics_32,x:-16.825,y:-188.025}).wait(1).to({graphics:mask_1_graphics_33,x:-8.575,y:-188.025}).wait(1).to({graphics:mask_1_graphics_34,x:-1.725,y:-188.025}).wait(1).to({graphics:mask_1_graphics_35,x:3.875,y:-188.025}).wait(1).to({graphics:mask_1_graphics_36,x:8.425,y:-188.025}).wait(1).to({graphics:mask_1_graphics_37,x:11.925,y:-188.025}).wait(1).to({graphics:mask_1_graphics_38,x:14.525,y:-188.025}).wait(1).to({graphics:mask_1_graphics_39,x:16.425,y:-188.025}).wait(1).to({graphics:mask_1_graphics_40,x:17.675,y:-188.025}).wait(1).to({graphics:mask_1_graphics_41,x:18.475,y:-188.025}).wait(1).to({graphics:mask_1_graphics_42,x:18.875,y:-188.025}).wait(1).to({graphics:mask_1_graphics_43,x:19.025,y:-188.025}).wait(1).to({graphics:mask_1_graphics_44,x:19.025,y:-188.025}).wait(97));

	// label.png
	this.instance_5 = new lib.Symbol15();
	this.instance_5.parent = this;
	this.instance_5.setTransform(71.6,-184.7,1,1,0,0,0,171.6,115.3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(28).to({_off:false},0).to({x:21.6},16,cjs.Ease.cubicOut).wait(97));

	// p2.png
	this.instance_6 = new lib.Symbol1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(0.5,-127.15,0.1207,0.1207,0,0,0,150.3,157.8);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({_off:false},0).to({regX:150.5,scaleX:1,scaleY:1,y:-142.2,alpha:1},16,cjs.Ease.backOut).wait(124));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:51.475,y:-143.875}).wait(6).to({graphics:null,x:0,y:0}).wait(135));

	// p3.png
	this.instance_7 = new lib.Symbol2();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-60,-175,1,1,0,0,0,150,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(4).to({x:0,alpha:1},16,cjs.Ease.quartOut).wait(121));
	...
	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(2).to({graphics:mask_3_graphics_2,x:-71.75,y:-145.325}).wait(7).to({graphics:null,x:0,y:0}).wait(132));

	// p1.png
	this.instance_8 = new lib.Symbol32();
	this.instance_8.parent = this;
	this.instance_8.setTransform(55,-175,1,1,0,0,0,150,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(2).to({_off:false},0).wait(4).to({x:0,alpha:1},16,cjs.Ease.quartOut).wait(119));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(23).to({_off:false},0).to({y:-156,alpha:1},16).wait(102));

	// bg.png
	this.instance_10 = new lib.Symbol9();
	this.instance_10.parent = this;
	this.instance_10.setTransform(0,-185.1,1,1.3928,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(141));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-185.1,-359.2,545.1,359.2);
...
(lib.Symbol40 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance}]},3).to({state:[{t:this.instance_1}]},2).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_5}]},2).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},14).to({state:[{t:this.instance_6}]},15).wait(107));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:20},3,cjs.Ease.get(-1)).to({_off:true},2).wait(146));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(15).to({_off:false},0).wait(14).to({startPosition:0},0).to({regX:71.4,regY:78.9,scaleX:2.8792,scaleY:2.8792,rotation:5.2309,x:-7.1,y:92.1},15,cjs.Ease.get(1)).wait(107));
...
(lib.Symbol55 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,0,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(45).to({startPosition:0},0).to({alpha:0},4).to({_off:true},2).wait(100));

	// m (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A6yTiMAAAgnDMA1lAAAMAAAAnDg");
	var mask_graphics_1 = new cjs.Graphics().p("A6yTiMAAAgnDMA1lAAAMAAAAnDg");
	var mask_graphics_2 = new cjs.Graphics().p("A6yTiMAAAgnDMA1lAAAMAAAAnDg");
	var mask_graphics_3 = new cjs.Graphics().p("A6yTiMAAAgnDMA1lAAAMAAAAnDg");
	var mask_graphics_4 = new cjs.Graphics().p("A6xTiMAAAgnDMA1kAAAMAAAAnDg");
	var mask_graphics_5 = new cjs.Graphics().p("A6yTiMAAAgnDMA1lAAAMAAAAnDg");
	var mask_graphics_6 = new cjs.Graphics().p("A6xTiMAAAgnDMA1jAAAMAAAAnDg");
	var mask_graphics_7 = new cjs.Graphics().p("A6xTiMAAAgnDMA1jAAAMAAAAnDg");
	var mask_graphics_8 = new cjs.Graphics().p("A6wTiMAAAgnDMA1hAAAMAAAAnDg");
	var mask_graphics_9 = new cjs.Graphics().p("A6wTiMAAAgnDMA1hAAAMAAAAnDg");
	var mask_graphics_10 = new cjs.Graphics().p("A6uTiMAAAgnDMA1dAAAMAAAAnDg");
	var mask_graphics_11 = new cjs.Graphics().p("A6sTiMAAAgnDMA1ZAAAMAAAAnDg");
	var mask_graphics_12 = new cjs.Graphics().p("A6qTiMAAAgnDMA1VAAAMAAAAnDg");
	var mask_graphics_13 = new cjs.Graphics().p("A6oTiMAAAgnDMA1RAAAMAAAAnDg");
	var mask_graphics_14 = new cjs.Graphics().p("A6lTiMAAAgnDMA1LAAAMAAAAnDg");
	var mask_graphics_15 = new cjs.Graphics().p("A6jTiMAAAgnDMA1GAAAMAAAAnDg");
	var mask_graphics_16 = new cjs.Graphics().p("A6iTiMAAAgnDMA1GAAAMAAAAnDg");
	var mask_graphics_17 = new cjs.Graphics().p("A6iTiMAAAgnDMA1FAAAMAAAAnDg");
	var mask_graphics_18 = new cjs.Graphics().p("A6jTiMAAAgnDMA1GAAAMAAAAnDg");
	var mask_graphics_19 = new cjs.Graphics().p("A6jTiMAAAgnDMA1GAAAMAAAAnDg");
	var mask_graphics_20 = new cjs.Graphics().p("A6jTiMAAAgnDMA1GAAAMAAAAnDg");
	var mask_graphics_21 = new cjs.Graphics().p("A6iTiMAAAgnDMA1FAAAMAAAAnDg");
	var mask_graphics_22 = new cjs.Graphics().p("A6jTiMAAAgnDMA1HAAAMAAAAnDg");
	var mask_graphics_23 = new cjs.Graphics().p("A6iTiMAAAgnDMA1FAAAMAAAAnDg");
	var mask_graphics_24 = new cjs.Graphics().p("A6jTiMAAAgnDMA1GAAAMAAAAnDg");
	var mask_graphics_25 = new cjs.Graphics().p("A6cTiMAAAgnDMA05AAAMAAAAnDg");
	var mask_graphics_26 = new cjs.Graphics().p("A6STiMAAAgnDMA0lAAAMAAAAnDg");
	var mask_graphics_27 = new cjs.Graphics().p("A6STiMAAAgnDMA0lAAAMAAAAnDg");
	var mask_graphics_28 = new cjs.Graphics().p("A6RTiMAAAgnDMA0jAAAMAAAAnDg");
	var mask_graphics_29 = new cjs.Graphics().p("A6RTiMAAAgnDMA0jAAAMAAAAnDg");
	var mask_graphics_30 = new cjs.Graphics().p("A6PTiMAAAgnDMA0fAAAMAAAAnDg");
	var mask_graphics_31 = new cjs.Graphics().p("A6NTiMAAAgnDMA0bAAAMAAAAnDg");
	var mask_graphics_32 = new cjs.Graphics().p("A6MTiMAAAgnDMA0ZAAAMAAAAnDg");
	var mask_graphics_33 = new cjs.Graphics().p("A6KTiMAAAgnDMA0VAAAMAAAAnDg");
	var mask_graphics_34 = new cjs.Graphics().p("A6ITiMAAAgnDMA0RAAAMAAAAnDg");
	var mask_graphics_35 = new cjs.Graphics().p("A6GTiMAAAgnDMA0NAAAMAAAAnDg");
	var mask_graphics_36 = new cjs.Graphics().p("A6DTiMAAAgnDMA0HAAAMAAAAnDg");
	var mask_graphics_37 = new cjs.Graphics().p("A6BTiMAAAgnDMA0DAAAMAAAAnDg");
	var mask_graphics_38 = new cjs.Graphics().p("A5+TiMAAAgnDMAz9AAAMAAAAnDg");
	var mask_graphics_39 = new cjs.Graphics().p("A58TiMAAAgnDMAz5AAAMAAAAnDg");
	var mask_graphics_40 = new cjs.Graphics().p("A56TiMAAAgnDMAz1AAAMAAAAnDg");
	var mask_graphics_41 = new cjs.Graphics().p("A55TiMAAAgnDMAzzAAAMAAAAnDg");
	var mask_graphics_42 = new cjs.Graphics().p("A54TiMAAAgnDMAzyAAAMAAAAnDg");
	var mask_graphics_43 = new cjs.Graphics().p("A54TiMAAAgnDMAzxAAAMAAAAnDg");
	var mask_graphics_44 = new cjs.Graphics().p("A53TiMAAAgnDMAzwAAAMAAAAnDg");
	var mask_graphics_45 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_46 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_47 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_48 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_49 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_50 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_51 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_52 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_53 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_54 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_55 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_56 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_57 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_58 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_59 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_60 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_61 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_62 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_63 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_64 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_65 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_66 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_67 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_68 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_69 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_70 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_71 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");
	var mask_graphics_72 = new cjs.Graphics().p("A53TiMAAAgnDMAzvAAAMAAAAnDg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:19.95,y:0}).wait(1).to({graphics:mask_graphics_1,x:24.025,y:0}).wait(1).to({graphics:mask_graphics_2,x:28.525,y:0}).wait(1).to({graphics:mask_graphics_3,x:33.425,y:0}).wait(1).to({graphics:mask_graphics_4,x:38.75,y:0}).wait(1).to({graphics:mask_graphics_5,x:44.55,y:0}).wait(1).to({graphics:mask_graphics_6,x:50.825,y:0}).wait(1).to({graphics:mask_graphics_7,x:51.275,y:0}).wait(1).to({graphics:mask_graphics_8,x:51.825,y:0}).wait(1).to({graphics:mask_graphics_9,x:52.55,y:0}).wait(1).to({graphics:mask_graphics_10,x:54.85,y:0}).wait(1).to({graphics:mask_graphics_11,x:57.875,y:0}).wait(1).to({graphics:mask_graphics_12,x:59.65,y:0}).wait(1).to({graphics:mask_graphics_13,x:61.65,y:0}).wait(1).to({graphics:mask_graphics_14,x:65.5,y:0}).wait(1).to({graphics:mask_graphics_15,x:69.1,y:0}).wait(1).to({graphics:mask_graphics_16,x:74.45,y:0}).wait(1).to({graphics:mask_graphics_17,x:79.55,y:0}).wait(1).to({graphics:mask_graphics_18,x:85.75,y:0}).wait(1).to({graphics:mask_graphics_19,x:90.7,y:0}).wait(1).to({graphics:mask_graphics_20,x:97,y:0}).wait(1).to({graphics:mask_graphics_21,x:101.6,y:0}).wait(1).to({graphics:mask_graphics_22,x:109.85,y:0}).wait(1).to({graphics:mask_graphics_23,x:115.2,y:0}).wait(1).to({graphics:mask_graphics_24,x:118.15,y:0}).wait(1).to({graphics:mask_graphics_25,x:123.825,y:0}).wait(1).to({graphics:mask_graphics_26,x:132.725,y:0}).wait(1).to({graphics:mask_graphics_27,x:136.1,y:0}).wait(1).to({graphics:mask_graphics_28,x:140.375,y:0}).wait(1).to({graphics:mask_graphics_29,x:145.65,y:0}).wait(1).to({graphics:mask_graphics_30,x:148.55,y:0}).wait(1).to({graphics:mask_graphics_31,x:152.325,y:0}).wait(1).to({graphics:mask_graphics_32,x:153.225,y:0.15}).wait(1).to({graphics:mask_graphics_33,x:154.25,y:0.3}).wait(1).to({graphics:mask_graphics_34,x:155.325,y:0.45}).wait(1).to({graphics:mask_graphics_35,x:156.925,y:0.2}).wait(1).to({graphics:mask_graphics_36,x:158.45,y:0}).wait(1).to({graphics:mask_graphics_37,x:161.275,y:0}).wait(1).to({graphics:mask_graphics_38,x:163.9,y:0}).wait(1).to({graphics:mask_graphics_39,x:168.825,y:0}).wait(1).to({graphics:mask_graphics_40,x:172.55,y:0}).wait(1).to({graphics:mask_graphics_41,x:182.65,y:0}).wait(1).to({graphics:mask_graphics_42,x:190.55,y:0}).wait(1).to({graphics:mask_graphics_43,x:196.575,y:0}).wait(1).to({graphics:mask_graphics_44,x:206.65,y:0}).wait(1).to({graphics:mask_graphics_45,x:213.6,y:0}).wait(1).to({graphics:mask_graphics_46,x:217.85,y:0}).wait(1).to({graphics:mask_graphics_47,x:226.45,y:0}).wait(1).to({graphics:mask_graphics_48,x:235.85,y:0}).wait(1).to({graphics:mask_graphics_49,x:243.85,y:0}).wait(1).to({graphics:mask_graphics_50,x:252.5,y:0}).wait(1).to({graphics:mask_graphics_51,x:258.55,y:0}).wait(1).to({graphics:mask_graphics_52,x:265.1,y:0}).wait(1).to({graphics:mask_graphics_53,x:269.65,y:0}).wait(1).to({graphics:mask_graphics_54,x:274.55,y:0}).wait(1).to({graphics:mask_graphics_55,x:278.9,y:0}).wait(1).to({graphics:mask_graphics_56,x:283.55,y:0}).wait(1).to({graphics:mask_graphics_57,x:285.8,y:0}).wait(1).to({graphics:mask_graphics_58,x:288.15,y:0}).wait(1).to({graphics:mask_graphics_59,x:290.7,y:0}).wait(1).to({graphics:mask_graphics_60,x:293.3,y:0}).wait(1).to({graphics:mask_graphics_61,x:296.05,y:0}).wait(1).to({graphics:mask_graphics_62,x:298.95,y:0}).wait(1).to({graphics:mask_graphics_63,x:301.55,y:0}).wait(1).to({graphics:mask_graphics_64,x:304.25,y:0}).wait(1).to({graphics:mask_graphics_65,x:304.05,y:0}).wait(1).to({graphics:mask_graphics_66,x:303.8,y:0}).wait(1).to({graphics:mask_graphics_67,x:304,y:0}).wait(1).to({graphics:mask_graphics_68,x:304.25,y:0}).wait(1).to({graphics:mask_graphics_69,x:305.8,y:0}).wait(1).to({graphics:mask_graphics_70,x:307.4,y:0}).wait(1).to({graphics:mask_graphics_71,x:312.45,y:0}).wait(1).to({graphics:mask_graphics_72,x:317.75,y:0}).wait(79));

	// bg_rust.jpg
	this.instance_1 = new lib.Symbol29();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,0,1,1,0,0,0,150,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},73).wait(78));

	// Layer_7
	this.instance_2 = new lib.warrv2("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-324.75,-83.9,1,1,0,0,0,58.2,29.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-291.75,startPosition:1},6).to({x:-290.3,startPosition:2},1).to({x:-288.7,startPosition:4},2).to({x:-283.55,startPosition:6},2).to({x:-278.6,startPosition:8},2).to({x:-270.6,startPosition:10},2).to({x:-221.6,startPosition:19},9).to({x:-209.85,startPosition:21},2).to({x:-196.55,startPosition:24},3).to({x:-189.35,startPosition:26},2).to({x:-185.25,startPosition:28},3).to({x:-179.55,startPosition:30},2).to({x:-173.55,startPosition:32},2).to({x:-164.5,startPosition:34},2).to({x:-119.75,startPosition:40},6).to({x:-99.7,startPosition:42},2).to({x:-82.7,startPosition:44},2).to({x:-69.65,startPosition:46},2).to({x:-60.7,startPosition:48},2).to({x:-51.85,startPosition:50},2).to({x:-32.25,startPosition:59},8).to({x:-31.15,startPosition:61},2).to({x:-31.5,startPosition:63},2).to({x:-28.5,startPosition:65},2).to({x:17.35,startPosition:76},11).to({x:31.55,startPosition:78},2).to({x:44.75,startPosition:80},2).to({x:62.15,startPosition:83},3).to({x:71.15,startPosition:86},3).to({x:74.8,startPosition:88},2).to({x:75.75,startPosition:90},2).to({x:224.7,startPosition:121},31).to({_off:true},1).wait(24));

	// sparkles copy 2
	this.instance_3 = new lib.Symbol38();
	this.instance_3.parent = this;
	this.instance_3.setTransform(14.65,-44.95,1,1,0,0,0,69.4,69.4);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(30).to({_off:false},0).wait(121));

	// sparkles copy 3
	this.instance_4 = new lib.Symbol38();
	this.instance_4.parent = this;
	this.instance_4.setTransform(86.15,-25.45,1,1,0,0,0,69.4,69.4);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(22).to({_off:false},0).wait(129));

	// sparkles copy
	this.instance_5 = new lib.Symbol38();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-37.35,33.05,1,1,0,0,0,69.4,69.4);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(14).to({_off:false},0).wait(137));

	// sparkles
	this.instance_6 = new lib.Symbol38();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-82.85,-96.95,1,1,0,0,0,69.4,69.4);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(5).to({_off:false},0).wait(146));

	// bg_norust.jpg
	this.instance_7 = new lib.Symbol10();
	this.instance_7.parent = this;
	this.instance_7.setTransform(0,0,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(151));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-398.7,-152.6,856.7,413.1);


// stage content:
(lib._181208adtr300x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(282).call(this.frame_282).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0},5).wait(286).to({startPosition:0},0).to({alpha:1},5).wait(1));

	// Layer_5
	this.instance_1 = new lib.Symbol56("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(238.5,673.6,1,1,0,0,0,88.5,63.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(172).to({startPosition:140},0).to({y:543.1},10,cjs.Ease.get(-1)).wait(115));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(169).to({_off:false},0).to({alpha:1},9).wait(119));

	// Layer_4 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A3bTjMAAAgnFMAu3AAAMAAAAnFg");
	mask.setTransform(150,126.1);

	// Layer_8
	this.instance_3 = new lib.Symbol40("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(276.1,143.7,1.2345,1.2345,0,0,0,20.5,85.5);
	this.instance_3._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(110).to({_off:false},0).wait(187));

	// Layer_1
	this.instance_4 = new lib.Symbol55("synched",0,false);
	this.instance_4.parent = this;
	this.instance_4.setTransform(208.65,166.1,1,1,0,0,0,58.2,39.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(297));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(114.9,300,395.1,310.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"181208_adtr_300x600_atlas_P_.png", id:"181208_adtr_300x600_atlas_P_"},
		{src:"181208_adtr_300x600_atlas_NP_.jpg", id:"181208_adtr_300x600_atlas_NP_"}
	],
	preloads: []
};
