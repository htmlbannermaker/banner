...
lib.ssMetadata = [
		{name:"181208_adtr_728x90_atlas_P_", frames: [[975,199,40,195],[926,741,59,199],[906,199,67,199],[906,0,89,197],[392,1085,142,186],[681,1215,132,164],[536,1215,143,158],[604,504,194,235],[800,504,194,235],[730,741,194,235],[0,756,728,90],[588,978,194,235],[0,252,300,250],[784,978,194,235],[0,1085,194,235],[392,848,194,235],[0,848,194,235],[196,848,194,235],[196,1085,194,235],[302,252,300,250],[604,252,300,250],[0,504,300,250],[302,504,300,250],[0,0,300,250],[302,0,300,250],[604,0,300,250]]},
...
(lib.Symbol35 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(58.9745,37.1149,1,1,33.2289);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol35, new cjs.Rectangle(24.5,0,69,74.2), null);
...
(lib.Symbol71 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_49 = new cjs.Graphics().p("AB8lMQgmAAAAhRIAAleQAAhRAmAAIQ0AAQAmAAAABRIAAFeQAABRgmAAg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(49).to({graphics:mask_graphics_49,x:123.7499,y:-84.484}).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(30).to({_off:false},0).to({x:94.1,y:-67.5,alpha:1},12,cjs.Ease.backOut).wait(64));

	// Layer_5
	this.instance_2 = new lib.Symbol58("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-126.8,159.2,1,1,0,0,0,73.1,30.7);
	this.instance_2._off = true;
...
p.nominalBounds = new cjs.Rectangle(-640,-315.2,914.3,364.7);
...
(lib._181208adtr728x90 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(555.7,207.25,0.815,0.815,0,0,0,50.1,51);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(172).to({mode:"single",startPosition:105},0).to({x:419.85},10,cjs.Ease.get(-1)).wait(115));
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(222.4,71.25,0.994,0.994,0,0,0,20.5,85.5);
	this.instance_3._off = true;
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(168.15,96.9,0.8052,0.8052,0,0,0,58.3,39.5);
...
p.nominalBounds = new cjs.Rectangle(245.4,-46.2,492.9,297.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"181208_adtr_728x90_atlas_P_.png?1546598863659", id:"181208_adtr_728x90_atlas_P_"},
		{src:"181208_adtr_728x90_atlas_NP_.jpg?1546598863659", id:"181208_adtr_728x90_atlas_NP_"}
	],
	preloads: []
};
